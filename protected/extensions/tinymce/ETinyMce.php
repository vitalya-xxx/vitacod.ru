      ...
      if ($this->useElFinder) {
          $options['file_browser_callback'] = 'js:function(field_name, url, type, win) {
            ...
            if($("#finder").length == 0) {
                ...
                $("#finder").elfinder({ zIndex: 9999999, places: "Избранное", url : "'.Yii::app()->getAssetManager()->publish(dirname(__FILE__).DIRECTORY_SEPARATOR.'assets').'/elfinder/connectors/connector.php?url='.Yii::app()->baseUrl.'/articlesImg/'.'",
                    lang : "en",
                    dialog : { width : 900, modal : true, title : "Файловый менеджер", zIndex: 777777 },
