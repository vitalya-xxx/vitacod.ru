...
$opts = array(
	'root'            => dirname(__FILE__).DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'articlesImg'.DIRECTORY_SEPARATOR, // path to root directory
	...
	// 'imgLib'       => 'auto',       // image manipulation library (imagick, mogrify, gd)
	 'tmbDir'       => 'tmbl',       // directory name for image thumbnails. Set to "" to avoid thumbnails generation
