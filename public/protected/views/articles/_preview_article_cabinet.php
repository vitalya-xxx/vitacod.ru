<div class="previewArticle">
    <div class="titleArticle">
        <?php echo CHtml::link($data->title, 'javascript:void(0)', array(
            'onClick' => 'showArticlePopup('.$data->idArticle.')',
        ));?>
    </div>
    ...
    <div class="previewArticleContainer">
        ...
        <div class="menuCategoryBlock">
            <span class="nameInfo">Раздел меню:</span><span class="valueInfo"><?php echo $data->idMenu0['title']?></span>
            <span class="nameInfo">Категория:</span><span class="valueInfo"><?php echo $data->idCategory0['title']?></span>
        </div>
        <div class="readMore">
            <?php echo CHtml::link('Читать далее...', 'javascript:void(0)', array(
                'onClick' => 'showArticlePopup('.$data->idArticle.', '.((1 == $data->moderationAppruv) ? "'public'" : "'appruve'").')',
            ));?>
        </div>
